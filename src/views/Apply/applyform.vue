            ...
            <div class="form-material">
                ...
                <div class="box-2" v-if="step === 1">
                    ...
                    <div class="form-input-controllor">
                        ...
                        <Input v-model="accountName" placeholder="输入用户名" />
                    </div>
                    <div class="form-input-controllor">
                        <div class="form-input-label normal-font text-grey ">电子邮箱:</div>
                        <Input v-model="accountEmail" placeholder="邮箱地址@163.com" />
                    </div>
                        <div class="form-input-controllor">
                            <div class="form-input-label normal-font text-grey ">联系人名:</div>
                        <Input v-model="accountUser" placeholder="联系人" />
                    </div>
                    <div class="form-input-controllor">
                        <div class="form-input-label normal-font text-grey ">联系电话:</div>
                        <Input v-model="accountPhone" placeholder="输入常用联系电话" />
                    </div>
                    <div class="form-input-controllor">
                        <div class="form-input-label normal-font text-grey ">身份证号:</div>
                        <Input v-model="accountPhone" placeholder="输入法人/用户身份证号码" />
                    </div>
                ...
                <div class="box-2" v-if="step === 2"></div>
                  <div class="form-btns">
                <Row type='flex'>
                    <Col :lg='{span:10,offset:2}' :md='{span:6,offset:2}' :sm='{span:11,offset:1}'> 
